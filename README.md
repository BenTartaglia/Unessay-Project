...
## Files
- `oil_unessay_artifact.py`  
  Python script used to generate the digital artifact.

- `oil_unessay_artifact.html`  
  Final exported HTML version of the artifact for easy viewing and presentation.
